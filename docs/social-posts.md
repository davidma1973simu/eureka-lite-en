# Eureka Lite — Social Media Posts

Use these posts with the assets in `assets/screenshots/`.

- `home.png` — product home + AI assistant
- `module.png` — guided RISE workspace
- `panorama.svg` — full project panorama
- `social-card.png` — promotional share card

---

## 1. LinkedIn

**Suggested image:** `social-card.png`

**Post copy:**

> Most innovation tools give you a blank canvas. Eureka Lite gives you a proven workflow.
>
...
> Turn raw observations into validated concepts with Eureka Lite — a lightweight, AI-assisted innovation workspace.
>
> 4 stages: Reveal → Inspire → Shape → Exam.
>
...
**Alternative (slightly longer, image carousel):**
...
**Suggested image:** `social-card.png` (square-friendly, bold colors)
...
>
> No signup. Free. Browser-based.
>
> 🔗 Link in bio / try it at davidma1973simu.github.io/eureka-lite-en
>
> #EurekaLite #Innovation #ProductDesign #StartupLife #DesignThinking #AI #Entrepreneur #BuildInPublic

**First comment (optional, for extra context):**

> 🧠 The built-in AI assistant has three modes: Help me brainstorm, Critique me, and Look it up. Bring your own API key or explore the example project right away.

---

## 5. Bonus: Universal short hook

Use this as a headline anywhere:

> **"Stop staring at a blank canvas. Start with a proven innovation flow."**
